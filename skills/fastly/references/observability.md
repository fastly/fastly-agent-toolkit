...
Fetch these for current details beyond what this skill covers. Strip trailing `/` and append `.md` to get markdown. Pages contain lists of available metrics and stats respectively.
