...
- `fastly-reference-architectures`: Curated GitHub repositories, Fastly-official or individually vouched for, demonstrating working reference architectures on Fastly, from single Compute applications to systems combining multiple Fastly products.
