...
- `fastly-reference-architectures`: Curated, Fastly-endorsed GitHub repositories demonstrating working reference architectures on Fastly, from single Compute applications to systems combining multiple Fastly products.
